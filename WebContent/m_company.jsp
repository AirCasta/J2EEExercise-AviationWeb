			...
			<div class="inner">
				<div class="general_content">
					...
					<div class="main_content">
							...
							<div class="table">
								<table width="100%" cellspacing="0" cellpadding="0" border="0">
									<tbody>
										...
										<%
											List<Information> companyList=(List<Information>)request.getAttribute("comp_list");
											SimpleDateFormat dateFormat=new SimpleDateFormat("yyyy-MM-dd");
											for(Information i:companyList){
										%>
										<tr>
											
											<td><%=i.getName() %></td>
											<td><%=i.getI_Attribute() %></td>
											<td><%=i.getI_Name() %></td>
											<td><%=dateFormat.format(i.getCreate_Date()) %></td>
											<td><a href="<%=basePath %>ManageCompServlet?method=delete&i_Id=<%=i.getI_Id() %>" class="ico del">删除</a>
												<a href="<%=basePath %>ManageCompServlet?method=edit&i_Id=<%=i.getI_Id() %>"class="ico edit">编辑</a></td>
										</tr>
										<%
											}
										%>
						...
						<a href="<%=basePath %>m_company_item.jsp">添加企业信息</a>
					</div>
