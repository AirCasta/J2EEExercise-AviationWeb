				...
				<div class="general_content">
					<div class="main_content">
						...
						<div class="block_media_posts">
							<%
								List<Photo> atlasList = (List) request.getAttribute("AtlasList");
								for (Photo p : atlasList) {
							%>
							<article class="block_media_post">
								<div class="f_pic">
									<a href="<%=basePath%>PhotoServlet?method=getAtlasPhotos&atlas_Name=<%=p.getAtlas_Name()%>"><img
										src="<%=basePath+p.getPh_Address() %>" alt="" /><span class="hover"></span></a>
								</div>

								<p class="title">
									<a href="<%=basePath%>PhotoServlet?method=getAtlasPhotos&atlas_Name=<%=p.getAtlas_Name()%>"><%=p.getAtlas_Name()%></a>
								</p>
							</article>
							<%
								}
						...
						<div class="block_search_top">
							<form action="#" />
							<div class="field">
								<input type="text" class="w_def_text" title="Search Picture" />
							</div>
