				...
				<div class="general_content">
					<div class="main_content">
						...
						<div class="block_registration">
							<form action="ManagerServlet" class="w_validation"/>
							...
							<div class="col_1">
								...
								<div class="field">
									<input type="text" class="req" name="m_Id" value="${form.m_Id }"/>
								</div>
								...
								<div class="field">
									<input type="password" class="req" name="m_Password" value="${form.m_Password }"/>
								</div>
								<div class="clearboth"></div>
